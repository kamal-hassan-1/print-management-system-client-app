          ...
          <View style={styles.settingsSection}>
            ...
            <View style={styles.settingRow}>
              ...
              <View style={styles.buttonsContainer}>
                <TouchableOpacity style={[styles.optionButton, pageRange === "all" && styles.optionButtonActive]} onPress={() => handlePageRangeChange("all")}>
                  <Text style={[styles.optionButtonText, pageRange === "all" && styles.optionButtonTextActive]}>All</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.optionButton, pageRange === "custom" && styles.optionButtonActive]} onPress={() => handlePageRangeChange("custom")}>
