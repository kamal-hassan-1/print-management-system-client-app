...
const Login = () => {
    ...
    useEffect(() => {
        if (pin.length === PIN_LENGTH) {
            if (pin === CORRECT_PIN) {
                // SUCCESS: Navigate to the Tabs group
                // .replace() prevents the user from going 'back' to login
                router.replace("/(tabs)/home"); 
            } else {
                // FAILURE: Clear pin and show alert
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.keypad}>
                ...
                <TouchableOpacity style={styles.key}>
                    <Feather name="touch-2" size={28} color="#FF8B7B" />
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.key} onPress={handleDelete}>
                    <Feather name="delete" size={26} color="#FF8B7B" />
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )
...
const styles = StyleSheet.create({
    ...
    pinDot: {
        ...
        height: 6,
        borderRadius: 3,
        backgroundColor: "#FF8B7B" // Default empty color
    },
    pinDotFilled: {
        backgroundColor: "#858b96" // Filled color
    },
    forgot: {
